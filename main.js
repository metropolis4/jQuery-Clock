...
// AM/FM BAND ROWS
    ...
    var $amRow = makeRows($amFreq, 'AM')
        .append("<span><span class='little'>X10</span> Khz</span>");

    var $fmRow = makeRows($fmFreq, 'FM')
        .append("<span class='Hz''>Mhz</span>");
